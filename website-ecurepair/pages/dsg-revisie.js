...
export default function EcuRevisie() {
  return (
    <>
      <Head>
        <title>
          ECU Repair &#8211; DSG revisie voor problemen en preventief onderhoud
        </title>
        <meta
          name="description"
          content="Problemen met de DSG automaat of preventief reviseren? ECU Repair voert DSG revisies uit met diagnose, duidelijke kosten en heldere terugkoppeling."
        />
      </Head>
